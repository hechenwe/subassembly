...
public class TestRegex {
	 ...
	 * @return
	 */
	    public static  List<String> getStrings(String oldString, String regex) {
		...
		while (matcher.find()) {
			int n = matcher.start() ;
			int m = matcher.end() ;
			String str1 = oldString.substring(tempLenth,n);
			String str2 = oldString.substring(n, m);
			list.add(str1);
			list.add(str2);
			tempLenth = m; 
			
		}
		String temp = oldString.substring(tempLenth,l);
		list.add(temp);
		return list;
	}
