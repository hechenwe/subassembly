...
public class DBConfig {
	...
	public static Connection getConnection() {
	    ...
	    String MYSQL_URL = "jdbc:mysql://"+IP+":"+PORT+"/"+DATA_NAME+"?useUnicode=true&characterEncoding="+ENCODEING;
		...
		try {
			connnection = DriverManager.getConnection(MYSQL_URL, USERNAME, PASSWORD);
